...
```{r policy correlation plot 2, echo=FALSE, message=FALSE}
z <- data.frame(
  #final_df$cases_per_100k_at_365d, 
             ...
             final_df$stay_at_home_days) %>%
  dplyr::rename(
    #cases_per_100k = final_df.cases_per_100k_at_365d, 
             transit_change = final_df.median_transit_change,
             pct_under_25 = final_df.pop_pct_age_0_24,
             pop_density = final_df.population_density,
             mask_days = final_df.mask_mandate_days,
             ue_ben_days = final_df.unemployment_benefits_days,
             ue_ins_amt = final_df.increased_weekly_unemployment_insurance_amt_thru_jul31,
             biz_closed_days = final_df.business_closed_days_round1,
