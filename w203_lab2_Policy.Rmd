...
model_I=cases_per_100k_at_365d ~ median_transit_change 
model_II=cases_per_100k_at_365d ~ median_transit_change + pop_pct_age_0_24 
model_III=cases_per_100k_at_365d ~ median_transit_change + pop_pct_age_0_24 + business_close_open_days
model_IV=cases_per_100k_at_365d ~ median_transit_change + pop_pct_age_0_24 + business_close_open_days+ mask_mandate_days
model_V=cases_per_100k_at_365d ~ median_transit_change + pop_pct_age_0_24 + business_close_open_days+ mask_mandate_days+unemployment_benefits_days
model_VI=cases_per_100k_at_365d ~ median_transit_change + pop_pct_age_0_24 + business_close_open_days+ mask_mandate_days+unemployment_benefits_days+ travel_quarantine_mandate_days
...
summary(lm.IV)
anova(lm.IV, lm.III, test = "F")
anova(lm.IV, lm.I, test = "F")
anova(lm.IV, lm.II, test = "F")
resid(lm.IV)
...
summary(lm.V)
anova(lm.V, lm.IV, test = "F")
anova(lm.V, lm.I, test = "F")
anova(lm.V, lm.II, test = "F")
resid(lm.V)
...
summary(lm.VI)
anova(lm.VI, lm.V, test = "F")
anova(lm.VI, lm.I, test = "F")
anova(lm.VI, lm.II, test = "F")
resid(lm.VI)
...
```{r}
mdl_name<-c('model_I','model_II','model_III','model_IV','model_V','model_VI')
