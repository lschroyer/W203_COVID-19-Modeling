...
m1 <- select(final_df, cases_per_100k_at_365d, median_transit_change,
...
```{r model check including days after policy enforced & insurance increase}

model_I=cases_per_100k_at_365d ~ median_transit_change + pop_pct_age_0_24 + population_density 
model_II=cases_per_100k_at_365d ~ median_transit_change + pop_pct_age_0_24 + population_density +unemployment_benefits_days
model_III=cases_per_100k_at_365d ~ median_transit_change + pop_pct_age_0_24 +population_density + stay_at_home_days
model_IV=cases_per_100k_at_365d ~ median_transit_change + pop_pct_age_0_24 + population_density +mask_mandate_days
model_V=cases_per_100k_at_365d ~ median_transit_change + pop_pct_age_0_24 + population_density + business_close_open_days
model_VI=cases_per_100k_at_365d ~ median_transit_change + pop_pct_age_0_24 + population_density + 
travel_quarantine_mandate_days
model_VII=cases_per_100k_at_365d ~ median_transit_change + pop_pct_age_0_24 + population_density + 
increased_weekly_unemployment_insurance_amt_thru_jul31
...
```{r model1 base model with transit change, 0-24 population, population density}
model_I
lm.I=lm(model_I,data=final_df)
summary(lm.I)
resid(lm.I)
shapiro.test(lm.I$residuals)
bptest(lm.I)
```


```{r model2 adding unemployment_benefits_days to base model}
model_II
...
```{r model3 adding stay_at_home_days to base model}
model_III
...
```{r model 4 adding mask mandate days to base model}
model_IV
...
```{r model7 adding increased_weekly_unemployment_insurance to base model}
model_VI
