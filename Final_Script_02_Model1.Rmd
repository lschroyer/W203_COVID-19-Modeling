...
```{r join census and mobility data, echo=FALSE, warning=FALSE, message=FALSE}
...
mat1 <- data.matrix(M)
print(M)
corrplot(mat1, method = "color", tl.col = 'black', is.corr=FALSE,
